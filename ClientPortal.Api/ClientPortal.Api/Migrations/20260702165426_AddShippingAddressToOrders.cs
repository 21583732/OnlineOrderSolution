    ...
    public partial class AddShippingAddressToOrders : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Clients__E67E1A245A5BCA1F", x => x.ClientId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6CD69823D63", x => x.ProductId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Cart__51BCD7B7E4045833", x => x.CartId);
                    table.ForeignKey(
                        name: "FK_Cart_Client",
                        column: x => x.ClientId,
                        principalTable: "Clients",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__C3905BCFB781CFEB", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK__Orders__ClientId__3F466844",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CartItem__488B0B0A62F9A7B7", x => x.CartItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderIte__57ED0681BADD435C", x => x.OrderItemId);
                    table.ForeignKey(
                        name: "FK__OrderItem__Order__4222D4EF",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId");
                    table.ForeignKey(
                        name: "FK__OrderItem__Produ__4316F928",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                });
